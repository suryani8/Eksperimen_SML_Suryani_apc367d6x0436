...
# KONEKSI KE DAGSHUB
# Menggunakan MLflow tracking URI ke DagsHub
...
# Menggunakan manual logging MLflow dengan metrik + 2 artefak tambahan:
# 1. Confusion Matrix (gambar)
# 2. Feature Importance (gambar)
# 3. ROC Curve (gambar)
...
with mlflow.start_run(run_name="RF_Manual_Tuning"):
    ...
    plt.show()
    print("Artefak 1: confusion_matrix.png tersimpan")
    ...
    plt.title('Top 15 Feature Importance - RF Tuning')
    plt.xlabel('Importance Score')
    plt.tight_layout()
    plt.savefig('feature_importance.png', dpi=150)
    mlflow.log_artifact('feature_importance.png')
    plt.show()
    print("Artefak 2: feature_importance.png tersimpan")
    ...
    plt.title('ROC Curve - RF Tuning')
    plt.legend(loc='lower right')
    plt.tight_layout()
    plt.savefig('roc_curve.png', dpi=150)
    mlflow.log_artifact('roc_curve.png')
    plt.show()
    print("Artefak 3: roc_curve.png tersimpan")
